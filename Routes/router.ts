...
router.get('/mensajes', (req: Request, res: Response)=>{
    client.query('SELECT * FROM mensajes').then((response: { rows: any; }) => {
...
router.get('/mensajes/:id', (req: Request, res: Response)=>{
    ...
    client.query(query).then((response: { rows: any; }) => {
...
router.get('/mensajes/fecha/:fecha1/:fecha2', (req: Request, res: Response)=>{
